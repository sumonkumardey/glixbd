...
import { ShoppingBag, Users, Package, TrendingUp, ChevronRight, Clock, ShieldCheck, Settings as SettingsIcon, Wallet, MessageSquare, ShieldAlert, MapPin } from 'lucide-react';
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3">
            <NavLink to="/admin/fraud-check" className="flex items-center justify-between p-4 bg-red-50 rounded-2xl group hover:bg-red-100 transition-colors">
              <div className="flex items-center gap-3">
                <ShieldAlert size={18} className="text-red-500" />
                <span className="font-bold text-red-600">ফ্রড কাস্টমার ট্র্যাকিং</span>
              </div>
              <ChevronRight size={18} className="text-red-400 group-hover:text-red-600" />
            </NavLink>
            <NavLink to="/admin/district-report" className="flex items-center justify-between p-4 bg-blue-50 rounded-2xl group hover:bg-blue-100 transition-colors">
              <div className="flex items-center gap-3">
                <MapPin size={18} className="text-blue-500" />
                <span className="font-bold text-blue-600">জেলা ভিত্তিক সেলস রিপোর্ট</span>
              </div>
            ...
            <NavLink to="/admin/reviews" className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl group hover:bg-primary/5 transition-colors">
              <div className="flex items-center gap-3">
                <MessageSquare size={18} className="text-primary" />
                <span className="font-bold">রিভিউ ম্যানেজমেন্ট</span>
              </div>
              <ChevronRight size={18} className="text-gray-400 group-hover:text-primary" />
            </NavLink>
