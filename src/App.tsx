...
const AdminFraudChecker = lazy(() => import('./components/admin/AdminFraudChecker'));
const AdminDistrictReport = lazy(() => import('./components/admin/AdminDistrictReport'));
          ...
          <Suspense fallback={
            ...
            <Routes>
              ...
              <Route path="/admin" element={<AdminRoute />}>
                ...
                <Route path="fraud-check" element={<AdminFraudChecker />} />
                <Route path="district-report" element={<AdminDistrictReport />} />
              </Route>
